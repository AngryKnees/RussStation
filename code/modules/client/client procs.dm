			...
			if("shop")
				if(href_list["KarmaBuy"])
					...
					switch(href_list["KarmaBuy"])
						...
						if("3")
							karma_purchase(karma,20,"job","Nanotrasen Representative")
						if("5")
							karma_purchase(karma,20,"job","Blueshield")
						if("6")
							karma_purchase(karma,20,"job","Mechanic")
						if("7")
							karma_purchase(karma,20,"job","Magistrate")
						if("9")
							karma_purchase(karma,20,"job","Security Pod Pilot")
				if(href_list["KarmaBuy2"])
					...
					switch(href_list["KarmaBuy2"])
						if("1")
							karma_purchase(karma,20,"species","Machine People","Machine")
						if("2")
							karma_purchase(karma,20,"species","Kidan")
						if("3")
							karma_purchase(karma,20,"species","Grey")
						if("4")
							karma_purchase(karma,20,"species","Vox")
						if("5")
							karma_purchase(karma,20,"species","Slime People")
						if("6")
							karma_purchase(karma,20,"species","Plasmaman")
						if("7")
